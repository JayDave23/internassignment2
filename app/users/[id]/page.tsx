...
const UserDetails: React.FC = () => {
  ...
  return (
    <div className="  m-10 max-w-md mx-auto bg-red-50 rounded-lg shadow-md p-4">
      <h1 className="text-black text-lg font-bold mb-4">Name :-{user.name}</h1>
      <p className="text-black font-bold ">Username :-</p><p className="text-black">{user.username}</p>
      <p className="text-black font-bold ">Email :-</p><p className="text-black">{user.email}</p>
